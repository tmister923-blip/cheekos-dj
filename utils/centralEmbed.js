...
class CentralEmbedHandler {
    ...
    async createCentralEmbed(channelId, guildId) {
        try {
            ...
            .setAuthor({ name: 'Cheekos Dj Control Center', iconURL: 'https://cdn.discordapp.com/emojis/896724352949706762.gif', url: 'https://www.instagram.com/cheek0s/' })
                .setDescription([
                    '',
                ...
                .setFooter({ 
                    text: 'Cheekos Dj • Developed By Cheekos!',
            ...
            if (trackInfo) {
                ...
                embed = new EmbedBuilder()
                    .setAuthor({ 
                        ...
                        url: 'https://www.instagram.com/cheek0s/' 
                    })
                    .setDescription([
                    ...
                    .setFooter({ 
                        text: `Cheekos Dj • ${statusText} Developed By Cheekos`,
                        iconURL: this.client.user.displayAvatarURL()
                    })
                    .setTimestamp();
