...
class EnterpriseConfigurationManager {
    ...
    constructPrimaryConfigurationSchema() {
        return {
             ...
             */
            lavalink: {
                host: EnvironmentVariableProcessor.LAVALINK_HOST || "193.149.164.213", 
                port: EnvironmentVariableProcessor.LAVALINK_PORT || 1600,       
            ...
            bot: {
                ...
                supportServer: "https://www.instagram.com/cheek0s/",    // 👈 Your support server link
